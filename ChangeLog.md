...
Current Trunk
-------------
- Emscripten will now warn if its not run vai the shell/bat launcher scripts.
  Please use `emcc` rather then `python emcc.py` to run python.  Warning can
  be disabled with `-Wno-launcher-script`.
